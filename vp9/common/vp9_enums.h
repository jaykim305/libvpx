...
typedef enum BITSTREAM_TYPE {
  INTER_FRAME_MODE_INFO = 0,
  INTRA_FRAME_MODE_INFO = 1,
  INTER_BLOCK_MODE_INFO = 2,
  INTRA_BLOCK_MODE_INFO = 3,
  INTER_BLOCK = 4,
  INTRA_BLOCK = 5,
  COMPRESSED_HDR = 6,
  READ_PARTITION = 7, 
  SETUP_TOKEN_DECODER = 8, 
  SKIP = 9, 
  UNKNOWN = 10, 
  BITSTREAM_TYPE_COUNT
} BITSTREAM_TYPE;

extern const char *BITSTREAM_TYPE_STRINGS[];
